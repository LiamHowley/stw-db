...
(define-test retrieving-data
  ...
  (db-connect db (retrieve-node)
    (let ((account (make-instance 'account :name "baz"))
          ...
          (*new-account* (sync (make-instance 'account :id 1) nil :optional-join '(user-url))))
